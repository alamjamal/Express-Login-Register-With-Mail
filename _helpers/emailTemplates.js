...
const activateURL=process.env.ACTIVATE_ACCOUNT_URL 
const forgotURL=process.env.CHANGE_PASSWORD_URL 

const accountVerification = (token) => `
<h2>Hi <a href="${activateURL}/${token}">  
Click Here </a>, To Activate Your Account</h2>`

const passwordReset = (token) => `
<h2>Hi <a href="${forgotURL}/${token}">  
Click Here </a>, To change Your Password</h2>`
